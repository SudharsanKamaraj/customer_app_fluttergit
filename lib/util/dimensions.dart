class Dimensions {
  ...
  static const double FONT_SIZE_ULTRA_LARGE = 27.0;
  static const double FONT_SIZE_SUPER_LARGE = 32.0;
  ...
  static const double RADIUS_EXTRA2_LARGE = 30.0;
  static const double RADIUS_OVER_LARGE  = 40.0;

  static const double MESSAGE_INPUT_HEIGHT = 60;
  static const double BUTTON_HEIGHT = 45;
  static const double BUTTON_HEIGHT_SMALL = 25;
}